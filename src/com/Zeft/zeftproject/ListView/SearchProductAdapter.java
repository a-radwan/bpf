...
public class SearchProductAdapter extends BaseAdapter implements ListAdapter{
...
//		}
		...
		public SearchProductAdapter(Context context, List<VendorHasProduct> vendorProducts) {
			this.context = context;
